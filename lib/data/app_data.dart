...
class Tags{
  static const String titleTags="Cuentanos que te hace mojarte la cola";
}
class ButtonText{
...
class WelcomeView{
  ...
  static const String ruleOneText="Asegúrate de que tus fotos, edad y biografía correspondan con quien eres actualmente.";
  static const String ruleTwoTitle="Cuídate.";
  static const String ruleTwoText="No des tu información personal demasiado pronto.";
  static const String ruleThreeTitle="Tómalo con calma.";
  static const String ruleThreeText="Respeta a los demás y trátalos como te gustaría que te trataran.";
...
class BirthdayView{
  ...
  static const String description= "Tu perfil muestra tu edad, no tu fecha de nacimiento";
}
class GenderView{
  static const String titleBottomSheet="Enriquece tu perfil con tu identidad";
  static const String descriptionBottomSheet= "Por favor cuentanos cómo te idenficicas Intentamos ser inclusivxs para todos los géneros.";
  static const String lblGenderBottomSheet="Escribe aquí tu género";

  static const String title="¿Qué género te representa mejor?";
  static const String description= "Elige la opción que mejor te represente para que podamos brindarte la mejor experiencia.";

  static const String titleQ="¿A quién te interesa ver?";
  static const String descriptionQ= "Selecciona todas las que apliquen, para que sepamos a quién recomendarte";
}
...
class HeightView{
  ...
  static const String description= "Esta información nos ayudará a hacer recomendaciones más precisas para ti.";
...
class CareerView{
  ...
  static const String description= "No te preocupes, podrás cambiar tu carrera más adelante si así lo deseas.";
  static const String titleQ="¿Qué carreras te gustaría ver?";
  static const String descriptionQ= "Selecciona las carreras que quieras, así sabremos a quién recomendarte";
}
